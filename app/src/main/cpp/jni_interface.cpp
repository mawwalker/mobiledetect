 ...
 ********************************************************************************************/
extern "C" JNIEXPORT void JNICALL
Java_com_dsm_mobiledetect_YOLOv5s_init(JNIEnv *env, jclass, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_dsm_mobiledetect_YOLOv5s_detect(JNIEnv *env, jclass, jobject image, jdouble threshold, jdouble nms_threshold) {
